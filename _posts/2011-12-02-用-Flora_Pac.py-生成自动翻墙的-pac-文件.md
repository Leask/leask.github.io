...
- id: 1221
  ...
  content: "[...] 原文：https://leaskh.com/2011/12/02/用-Flora_Pac.py-生成自动翻墙的-pac-文件/ [...]"
- id: 1222
  author: "用 Flora_Pac.py 生成自动翻墙的 pac 文件 &laquo; 细节的力量"
  author_email: ''
  author_url: http://xijie.wordpress.com/2011/12/04/%e7%94%a8-flora_pac-py-%e7%94%9f%e6%88%90%e8%87%aa%e5%8a%a8%e7%bf%bb%e5%a2%99%e7%9a%84-pac-%e6%96%87%e4%bb%b6/
...
源于人们对自由的向往，翻墙技术已渐趋成熟。愿意花点钱，购买海外 VPN 和 ssh 主机用于自由获取信息是目前比较有效的手段。如我之前文章中提及，这两种方式都有需要筛选出那些网站在墙外，那些网站在墙内，以较节约、高速的方式访问网络。八仙过海，各显神通，不少帮助人们解决这一问题，降低翻墙门槛的小项目出现了。较具代表性的有 chnroutes([http://code.google.com/p/chnroutes/](http://code.google.com/p/chnroutes/)) 项目和 autoproxy-gfwlist([http://code.google.com/p/autoproxy-gfwlist/](http://code.google.com/p/autoproxy-gfwlist/)) 项目。前者修改路由表，配合各种 VPN 使用，后者可以配合 AutoProxy for Firefox([https://addons.mozilla.org/firefox/addon/11009](https://addons.mozilla.org/firefox/addon/11009)) 或导出([https://autoproxy2pac.appspot.com/](https://autoproxy2pac.appspot.com/))为 pac 文件，配合各种代理服务器，包括 ssh -D 使用。他们的原理稍有差异，chnroutes 只区分国内外 IP 段，让国外地址全部走翻墙路线，autoproxy-gfwlist 项目则精确记录着那些网站被墙。
...
Flora_Pac 使用 Python 开发，能自动抓取 [apnic.net](http://apnic.net) 的 IP 数据，找出所有国内的 IP 地址段，生成能让浏览器自动判断国内外 IP 地址的 pac 文件，让代理用户有等价于 VPN + chnroutes 的翻墙体验。Flora_Pac 使用十分简单，兼容各种平台：
...
项目代码我放在 github 上开源了：[https://github.com/Leask/Flora_Pac](https://github.com/Leask/Flora_Pac)，其中 fetch_ip_data 函数 fork 自 chnroutes 项目。

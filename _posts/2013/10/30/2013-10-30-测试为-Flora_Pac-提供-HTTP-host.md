...
$ curl [http://flora.leaskh.com/pac?proxy=SOCKS%20127.0.0.1%3A8964](http://flora.leaskh.com/pac?proxy=SOCKS%20127.0.0.1%3A8964)

* 创建代理地址为 SOCKS5 127.0.0.1:8964 的 PAC 文件:  
$ curl [http://flora.leaskh.com/pac?proxy=SOCKS5%20127.0.0.1%3A8964](http://flora.leaskh.com/pac?proxy=SOCKS5%20127.0.0.1%3A8964)

* 创建代理地址为 HTTP 127.0.0.1:6489 的 PAC 文件:  
$ curl [http://flora.leaskh.com/pac?proxy=PROXY%20127.0.0.1%3A6489](http://flora.leaskh.com/pac?proxy=PROXY%20127.0.0.1%3A6489)

* 当第一代理 ( SOCKS5 127.0.0.1:8964 ) 失败时尝试第二代理 ( SOCKS 127.0.0.1:8964 ):  
$ curl [http://flora.leaskh.com/pac?proxy=SOCKS5%20127.0.0.1%3A8964%3B%20SOCKS%20127.0.0.1%3A8964](http://flora.leaskh.com/pac?proxy=SOCKS5%20127.0.0.1%3A8964%3B%20SOCKS%20127.0.0.1%3A8964)

基本上就这样，如 demo 所示，直接把代理服务器地址转义后填入 proxy 参数中，请求 Flora_Pac 服务器（[http://flora.leaskh.com/pac](http://flora.leaskh.com/pac)）就行。其中 URL 参数的转义规则 Google 一下很容易查到。下面列出可能会被用到的几个符号：
